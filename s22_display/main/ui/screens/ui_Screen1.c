...
ui_SpeedMeter = lv_arc_create(ui_Screen1);
...
ui_PWMMeter = lv_arc_create(ui_Screen1);
...
ui_PWMValue = lv_label_create(ui_Screen1);
...
ui_PWMLabel = lv_label_create(ui_Screen1);
...
ui_BatteryValue = lv_label_create(ui_Screen1);
...
ui_TempIcon = lv_label_create(ui_Screen1);
...
ui_CurrentIcon = lv_label_create(ui_Screen1);
...
ui_VoltIcon = lv_label_create(ui_Screen1);
...
ui_CurrentValue = lv_label_create(ui_Screen1);
